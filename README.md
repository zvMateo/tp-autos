...
- **Presentación** — 14 slides a pantalla completa (incluye «¿Qué son las funciones?», «Fuentes y confiabilidad» y «Puente a Python»), navegables con el teclado (←/→/Espacio).
...
components/slides/  las 14 slides + SlideFrame
